...
public class Grafo {
    ...
    public void agregarArista(int origen, int destino){
        buscarVertice(origen).aristas.add(new Nodo(destino));  //Buscar el vértice origen y agrega un nodo al final de la lista de aristas de ese vértice
    }
    ...
    public void imprimeGrafo(){
        ...
        for(int i = 0; i < this.vertices.size(); i++){
            ...
            for(int j = 0; j < actual.aristas.size(); j++){
                System.out.println("Arista de "+actual.vertice+ " a " + actual.aristas.get(j).vertice + " con peso " );
            }
        }
    }
